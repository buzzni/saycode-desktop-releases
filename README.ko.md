...
### [⬇️ macOS용 다운로드 (Apple Silicon)](https://github.com/buzzni/saycode-desktop-releases/releases/download/v0.1.39/Saycode-0.1.39-arm64.dmg)
...
- [최신 릴리스 노트](docs/releases/v0.1.39.ko.md)
