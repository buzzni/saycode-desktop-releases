...
- 💻 **원격 터미널** — 프로젝트 머신의 진짜 셸을 채팅 옆에 도킹
...
| | | |
|---|---|---|
| **01 · 말로 요청** | **02 · AI가 제작** | **03 · 즉시 미리보기** |
| 자연어 한 문장이면 됩니다: *"비품·구매 요청 관리 백오피스 만들어줘"* | 에이전트가 실제 파일을 읽고 쓰고, 명령을 실행하며 전 과정을 스트리밍합니다. | 옆 패널에 진짜 동작하는 화면이 바로 뜹니다 — 만들어지는 동안 직접 눌러보세요. |

| |
|---|
| **04 · 팀에 배포** — 버튼 한 번으로 사내 URL 발급. 공유하고, 인수인계하고, 함께 발전시키세요. |
